...
<body>
	...
	<form>
		<input type="hidden"  name="c_b_idx" value="${ vo.c_b_idx }">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
				   <table class="table">
				       <tr>
				           <th>제목</th>
				           <td><input name="c_b_subject"  value="${ vo.c_b_subject }"></td>
				       </tr>
				       
				       <tr>
				           <th>내용</th>
				           <td>
	                      <textarea  name="c_b_content" rows="5" cols="50">${ vo.c_b_content }</textarea>
	                      <script>
