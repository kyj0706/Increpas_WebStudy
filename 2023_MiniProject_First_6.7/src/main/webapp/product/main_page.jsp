						...
						<div class="login_menu">
							<ul>
								...
								<c:if test="${not empty user }">
									<li>
										<span>등급 : [${user.user_grade}] =>  ${user.user_name }님 환영합니다.</span>
									</li>
									<li>
								...
								<!-- 판매만 보여지게 -->
								<c:if test="${user.user_grade eq '판매' }">
									<li>
										<a href="../product/insert_form.do"> 
											<i class="fa fa-tags" aria-hidden="true"></i> 
											<span class="padding_10">상품/경매 등록</span>
										</a>
									</li>
								</c:if>
								...
								<c:if test="${user.user_grade eq '관리' }">
									<li>
										<a href="../user/list.do"> 
											<i class="fa fa-tags" aria-hidden="true"></i> 
											<span class="padding_10">회원목록</span>
										</a>
									</li>	
								</c:if>	
						...
						<div class="carousel-item active">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="buynow_bt">
										<a href="../auction/list.do"> Buy Now </a>
									</div>
								</div>
							</div>
								...
								<c:forEach var="vo" items="${ list }">
									<div class="col-lg-3 col-sm-4">
										<div class="box_main">
											...
											<div class="">
												<img src="../images/${vo.product_image1}" id="list_img2">
											</div>
											<div class="btn_main">
												<div class="buy_bt">
