					...
					<div class="containt_main">
						...
						<div id="detail_l_table" class="detail_big_img">
							<img id="img1" class="detail_l_img"
								src="../images/bc235ee11461d2c05bfd17b5a60105f18e5223b3.png">
						</div>
						...
						<div>
							<table border="1" class="banner_taital2" id="detail_table">
								...
								<tr>
									<td width="50%" >주문요청번호</td>
									<td width="50%" >입찰날짜</td>
								</tr>
								<tr>
									<td width="50%" >order_idx</td>
								...
								<tr>
									<td width="50%">입찰가격</td>
									<td width="50%">결제 요청사항</td>
								</tr>

								<tr>
									<td width="50%">oreder_price</td>
