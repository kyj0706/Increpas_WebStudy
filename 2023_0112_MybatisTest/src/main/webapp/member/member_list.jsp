...
<div id="box">
	  ...
	  <div style="text-align: right;">
	  	<input class="btn btn-success" type="button" id="mem_sign_up" value="회원가입" onclick="location.href='insert_form.do'">
	  </div>
	  </c:if>
	  
<div class="panel">
      <div class="panel-heading"><span class="glyphicon glyphicon-th-list"> 회원리스트</span> </div>
