	...
	<form>
		...
		회원가입</div>
		    <table class="mem_tb">
			    <tr>
					<th id="text">이름</th>
					<td><input name="c_mem_name" id="c_mem_name" size="25"></td>
				</tr>
				<tr>
					<th id="text">ID</th>
					<td><input name="c_mem_id" id="c_mem_id" size="25"><span id="id_msg"></span></td>
					<!-- 네임태그는 서버 아이디는 클라이언트에서 사용 -->
				</tr>
				<tr>
					<th id="text">비밀번호</th>
					<td><input type="password" name="c_mem_pwd" id="c_mem_pwd" size="25"></td>
				</tr>
				<tr>
					<th id="text">비밀번호 확인</th>
					<td><input type="password" name="c_mem_pwd2" id="c_mem_pwd2" size="25"><span id="id_msg2"></span></td>
				</tr>
				<tr>
					<th id="text">우편번호</th>
					<td>
					<input name="c_mem_zipcode" id="c_mem_zipcode" size="25">
