...
//======================================================================================================================================================			
			//KODEX 한중전기차(합성)
			doc = Jsoup.connect(URL_6).userAgent(
					"Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1667.0 Safari/537.36")
					.header("scheme", "https")
					.header("accept",
							"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8")
			...
			StockVo svo6 = new StockVo(name, NowPrice, vsyesterday, DungRakrate, yesterdayPrice, sigaPrice, HighPrice, LowPrice, georaeryang, TradingValue);
