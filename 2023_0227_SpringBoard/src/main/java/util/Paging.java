...
//---------------------------------------------------------------------------------------------------------------------	    
	...
	public static String getPaging(
		...
		int totalPage /* 전체페이지수 */, startPage /* 시작페이지번호 */, endPage /* 마지막페이지번호 */ ,firstPage , lastPage;
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if (isPrevPage) {
			...
			sb.append(String.format("<a href='%s?page=%d&%s'>첫번째</a><a href='%s?page=%d&%s'>||이전</a>"
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if (isNextPage) {
			...
			sb.append(String.format("<a href='%s?page=%d&%s'>다음||</a><a href='%s?page=%d&%s'>마지막</a>"
